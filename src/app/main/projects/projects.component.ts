      ...
      en: [
        {
          ...
          description: 'Real Linux-style CLI in your browser: run 32+ commands (ls, cat, ping, dig etc.), full file navigation, embedded nano editor, chaining & sudo auth, authentic errors and live data.',
      ...
      es: [
        {
          name: 'Interactive Terminal',
          technologies: 'Angular | TypeScript | SCSS | HTML | Node.js | Flask',
          description: 'Terminal Linux en el navegador: +32  comandos (ls, cat, ping…), navegación de archivos, editor nano, chaining y sudo, errores reales y datos en vivo.',
          img: 'img/terminal.webp',
          link: 'https://lukasbusch.dev/cmd',
          github: 'https://github.com/lukasbuschdev/portfolio'
        },        
      ...
      de: [
        {
          ...
          technologies: 'Angular | TypeScript | SCSS | HTML | Node.js | Flask',
          description: 'Echte Linux-CLI im Browser: 32+ Befehle (ls, cat, ping, dig), vollständige Dateinavigation, integrierter Nano-Editor, Befehlsketten & sudo, authentische Fehlermeldungen & Live-Daten.',
          img: 'img/terminal.webp',
          link: 'https://lukasbusch.dev/cmd',
          github: 'https://github.com/lukasbuschdev/portfolio'
        },        
